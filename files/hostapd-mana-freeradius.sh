...
SESSION='PatataWifi_Hostapd_Mana'
...
echo -e "\033[0;32m\033[0;33m[PatataWiFi: Hostapd-Mana + FreeRadius]\033[0m"
...
do
    ...
    sed "s/\[VIRTUALINTERFACE\]/${wlan_ap}_$((i+1))/; s/\[SSID\]/${ssid_list[$i]}/" ${MY_PATH}/hostapd-mana/hostapd/patatawifi-virtual.conf >> ${MY_PATH}/hostapd-mana/hostapd/${hostapdconf}
...
tmux select-pane -t 0
tmux send-keys "cd ${MY_PATH}/hostapd-mana/hostapd/" C-m
